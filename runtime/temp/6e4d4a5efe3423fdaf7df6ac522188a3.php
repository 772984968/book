<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:52:"/var/www/book/public/../app/book/view/index/hot.html";i:1521291159;s:56:"/var/www/book/public/../app/book/view/common/header.html";i:1521190226;s:56:"/var/www/book/public/../app/book/view/common/footer.html";i:1521191972;}*/ ?>
...
<div class="j-header">
    <div class="j-top">
        ...
        <div class="link">
            ...
            <a class="cur" href="<?php echo url('index/hot'); ?>">排行</a>
        </div>
...
<?php endif; ?>
    ...
    <div class="j-app-banner" id="j_ad_app" >
        ...
        <script src="__static__/Scripts/c.js" type="text/javascript"></script>
    </div>
        ...
        <!-- type: 1 cate:  - -->
            ...
            <div class="j-r-nav">
                <ul>
                       ...
                       <li    class="<?php echo $jinghua; ?>"><a href="<?php echo url('index/hot'); ?>">精华</a>
                        </li>
                        <li class="<?php echo $old; ?>"><a href="<?php echo url('index/hot',['type'=>'old']); ?>">穿越</a>
                        </li>
    ...
    <div class="u-img">
        <a href="<?php echo url('user/topic',['uid'=>$vo['id']]); ?>" target="_blank">
            <img class="u-logo lazy"
                 src="__static__/Picture/d_user_logo.jpg"
                 data-original="<?php echo $vo['head']; ?>"
                 alt="<?php echo $vo['name']; ?>"/>
        </a>
    </div>
    <div class="u-txt">
        <a href="<?php echo url('user/topic',['uid'=>$vo['id']]); ?>" class="u-user-name" target="_blank"><?php echo $vo['name']; ?></a>
...
<?php endforeach; endif; else: echo "暂时没有数据" ;endif; ?>                </div>
            </div>
        </div>
...
<script type="text/javascript"
        src="__static__/Scripts/cc8d3678eeb44e279f57c3ea2d1e3821.js"></script>
<script type="text/javascript">
    var jie = window['jie'] || {};
    jie['common_config'] = {};
    jie['is_oauth_login'] = '';
...
<script src="__static__/Scripts/require.js"></script>
    ...
    <script src="__static__/Scripts/config.js"></script>
