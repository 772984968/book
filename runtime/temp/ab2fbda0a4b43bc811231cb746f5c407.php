<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"/var/www/book/public/../app/admin/view/index/default.html";i:1521259752;s:57:"/var/www/book/public/../app/admin/view/public/header.html";i:1520738488;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="gray-bg top-navigation">
            ...
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-static-top" role="navigation">
                    <div class="navbar-header">
                        ...
                        <a href="#" class="navbar-brand">默认菜单</a>
                    </div>
                    <div class="navbar-collapse collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a aria-expanded="false" role="button" href="#" class="dropdown-toggle" data-toggle="dropdown">开发菜单<span class="caret"></span></a>
                                <ul role="menu" class="dropdown-menu">
                                    <li><a  onclick="layer_show('添加菜单','<?php echo url('develop/makecontroller'); ?>')" href="javascript:void(0);">新增控制器</a>
                                    </li>
                                    <li><a  onclick="layer_show('添加菜单','<?php echo url('develop/makemodel'); ?>')">新增模型</a>
                                    </li>
                                    <li><a onclick="layer_show('添加菜单','<?php echo url('access/add'); ?>')">新增菜单列表</a>
                                    </li>
                                </ul>
                            </li>
                          </ul>
    ...
    <script src="__static__/js/plugins/chartJs/Chart.min.js"></script>
    <script src="__static__/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="__static__/js/demo/peity-demo.min.js"></script>
