<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"/var/www/book/public/../app/book/view/user/video.html";i:1521292986;s:56:"/var/www/book/public/../app/book/view/common/header.html";i:1521190226;s:56:"/var/www/book/public/../app/book/view/common/footer.html";i:1521191972;}*/ ?>
﻿
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<link rel="stylesheet" href="__static__/Css/contribute.css">
    ...
    <div class="j-content">
        <div class="g-bd f-cb">
            ...
            <form action="<?php echo url('user/publish'); ?>" method="post">
            <div class="g-mn">
    ...
    <div class="j-tab-c-file-c ">
        ...
        <div class="j-tab-c-file-ing" id="afterUploadContain" style="display: none;">
            <div class="j-tab-c-file-ing-l">
                <i class="icon-file-video"><input name="src" value="" type="hidden" id="filesrc"></i>
            </div>
...
<script type="text/javascript">
    ...
    <!--  <script src="__static__/Scripts/fileupload.js"></script>-->
    <script src="__static__/Scripts/jquery.blockui.js"></script>
...
<script src="__static__/Scripts/require.js"></script>
    ...
    <script src="__static__/Scripts/publish.config.js"></script>
