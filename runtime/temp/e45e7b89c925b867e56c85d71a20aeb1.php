<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"/var/www/book/public/../app/book/view/index/text.html";i:1521290641;s:56:"/var/www/book/public/../app/book/view/common/header.html";i:1521190226;s:56:"/var/www/book/public/../app/book/view/common/footer.html";i:1521191972;}*/ ?>
...
<div class="j-header">
    <div class="j-top">
        ...
        <div class="link">
            ...
            <a class="cur" href="<?php echo url('index/text'); ?>">文字</a>
            ...
            <div class="j-r-c">
                ...
                <div class="j-r-nav">
                    <ul>
                      ...
                      <li    class="<?php echo $jinghua; ?>"><a href="<?php echo url('index/text'); ?>">精华</a>
                        </li>
                        <li class="<?php echo $old; ?>"><a href="<?php echo url('index/text',['type'=>'old']); ?>">穿越</a>
                        </li>
                    </ul>
                </div>
