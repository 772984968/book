<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"/var/www/book/public/../app/admin/view/index/index.html";i:1520738488;s:57:"/var/www/book/public/../app/admin/view/public/header.html";i:1520738488;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><?php echo \think\Session::get('username'); ?></strong></span>
...
<?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
 <li>
	...
	<?php if(is_array($vo['son']) || $vo['son'] instanceof \think\Collection || $vo['son'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?>
                            <li>
                                <a class="J_menuItem" href="<?php echo url($voo['url']); ?>" data-index="0"><?php echo $voo['title']; ?></a>
                            </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="<?php echo url('index/default'); ?>">首页</a>
                    </div>
                    <a href="<?php echo url('index/default'); ?>"></a>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo url('index/default'); ?>" frameborder="0" data-id="<?php echo url('index/default'); ?>" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2017 <a href="" target="_blank"></a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
