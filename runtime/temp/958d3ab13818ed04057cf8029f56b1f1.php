<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"/var/www/book/public/../app/book/view/user/voice.html";i:1521292956;s:56:"/var/www/book/public/../app/book/view/common/header.html";i:1521190226;s:56:"/var/www/book/public/../app/book/view/common/footer.html";i:1521191972;}*/ ?>
﻿
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<link rel="stylesheet" href="__static__/Css/contribute.css">
    ...
    <div class="j-content">
        <div class="g-bd f-cb">
			...
			<form action="<?php echo url('user/voice'); ?>" method="post">
            <div class="g-mn">
            ...
            <div class="j-tab-c">
                <div class="j-tab-c-hide j-tab-c-show j-tab-c-text">
                    <!-- 文件区域 上传图片 视频 音频   -->
                        ...
                        <!-- 声音   -->
<!-- 因为多文件同时上传提交操作  所以用 form -->
<from id="fileUpload">
    <div class="j-tab-c-file">
        <div class="j-tab-c-file-c ">
            <!-- 添加封面图区域   -->
            <div class="j-tab-c-file-add fileinput-button" id="fileAddBimage">
            ...
            <!-- 添加封面图之后   -->
            <div class="j-tab-c-file-ing " id="fileBimageC" style="display: none;">
                   <img src="" id="fileimg" width="170" height="70">
			<input name="src" value="" type="hidden" id="filesrc">
            </div>

            <!-- 添加声音区域   -->
            <div class="j-tab-c-file-add fileinput-button" id="fileAddVoice" style="margin-left: 10px;">
                <div class="j-tab-c-file-c-video ">
                    <i class="icon-file-audio"></i>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上传声音
                </div>
                <input type="file" name="voice" id="voiceUpload" multiple>
                	<input name="voice" value="" type="hidden" id="voice">
            </div>

            <!-- 添加声音之后   -->
            <div class="j-tab-c-file-ing " id="fileVoiceC" style="margin-left: 10px; display: none;">
                <div class="j-tab-c-file-ing-l">
                    <i class="icon-file-audio"></i>
                </div>
            </div>
            <!-- 文件名   -->
            <div class="j-tab-c-file-des">
                <p class="j-tab-c-file-des-text" id="txtUploadFileNameImg"></p>

                <p class="j-tab-c-file-des-text" id="txtUploadFileNameVoice" style="margin-left: 10px;"></p>
            </div>
        </div>
    </div>
...
<script type="text/javascript"
        src="__static__/Scripts/98335b875a3c409ab9e484e4625b2c9d.js"></script>
                <!-- 上传接口 -->
...
layui.use('upload', function(){
  ...
  //执行实例
  var uploadInst = upload.render({
    elem: '#voiceUpload' //绑定元素
    ,url: "<?php echo url('user/uploadVoice'); ?>" //上传接口
    ,done: function(res){
        if (res.code==1){
            layer.msg(res.msg);
            //$("#fileVoiceC").css('display','');
            $("#voice").attr('value',res.data.voice);
