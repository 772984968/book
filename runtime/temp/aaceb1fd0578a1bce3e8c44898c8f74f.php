<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"/var/www/book/public/../app/book/view/index/voice.html";i:1521291039;s:56:"/var/www/book/public/../app/book/view/common/header.html";i:1521190226;s:56:"/var/www/book/public/../app/book/view/common/footer.html";i:1521191972;}*/ ?>
...
<div class="j-header">
    <div class="j-top">
        ...
        <div class="link">
            ...
            <a class="cur" href="<?php echo url('index/voice'); ?>">声音</a>
    ...
    <div class="g-bd f-cb">
        ...
        <div class="g-mn">
            ...
            <div class="j-r-c">
                ...
                <div class="j-r-nav">
                    <ul>
						<li    class="<?php echo $jinghua; ?>"><a href="<?php echo url('index/voice'); ?>">精华</a>
                        </li>
                        <li class="<?php echo $old; ?>"><a href="<?php echo url('index/voice',['type'=>'old']); ?>">穿越</a>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="j-r-list-c">
                                ...
                                <img src="<?php echo $vo['src']; ?>">
                                 <embed src="http://<?php echo $vo['src']; ?>">
